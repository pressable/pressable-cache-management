  ...
  <div class="wrap branding-<?php $remove_pressable_branding_tab_options; ?>">
	...
	<nav class="nav-tab-wrapper">
	  ...
	  <?php
		...
		?>
																								">Object Cache</a>
	  <a href="admin.php?page=pressable_cache_management&tab=cdn_settings_tab" class="nav-tab nav-tab-cdn 
	  <?php
		if ( $tab === 'cdn_settings_tab' ) :
			?>
			nav-tab-active
																												   <?php
	endif;
		?>
																											">CDN</a>
	  <a href="admin.php?page=pressable_cache_management&tab=pressable_api_authentication_tab" class="nav-tab nav-tab-api 
	  <?php
		if ( $tab === 'pressable_api_authentication_tab' ) :
			?>
			nav-tab-active
																																   <?php
	endif;
