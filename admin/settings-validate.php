<?php
/**
 * Pressable Cache Management - Validate Settings.
 *
 ...
 *
 * @param array $input The options array to validate.
...
function pressable_cache_management_callback_validate_options( $input ) {
	...
	$input['extend_batcache_checkbox'] = filter_var( 1 === $input['extend_batcache_checkbox'] ? 1 : 0, FILTER_SANITIZE_NUMBER_INT );
	...
	$input['flush_cache_theme_plugin_checkbox'] = filter_var( 1 === $input['flush_cache_theme_plugin_checkbox'] ? 1 : 0, FILTER_SANITIZE_NUMBER_INT );
	...
	$input['flush_cache_page_edit_checkbox'] = filter_var( 1 === $input['flush_cache_page_edit_checkbox'] ? 1 : 0, FILTER_SANITIZE_NUMBER_INT );
	...
	$input['flush_cache_on_page_post_delete_checkbox'] = filter_var( 1 === $input['flush_cache_on_page_post_delete_checkbox'] ? 1 : 0, FILTER_SANITIZE_NUMBER_INT );
	...
	$input['flush_cache_on_comment_delete_checkbox'] = filter_var( 1 === $input['flush_cache_on_comment_delete_checkbox'] ? 1 : 0, FILTER_SANITIZE_NUMBER_INT );
	...
	$input['flush_object_cache_for_single_page'] = filter_var( 1 === $input['flush_object_cache_for_single_page'] ? 1 : 0, FILTER_SANITIZE_NUMBER_INT );

	// Flush Batcache for WooCommerce individual page.
	$input['flush_batcache_for_woo_product_individual_page_checkbox'] = isset( $input['flush_batcache_for_woo_product_individual_page_checkbox'] ) ? filter_var( 1 === $input['flush_batcache_for_woo_product_individual_page_checkbox'] ? 1 : 0, FILTER_SANITIZE_NUMBER_INT ) : 0;
