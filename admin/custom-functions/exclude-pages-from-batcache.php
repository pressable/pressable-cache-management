	...
	if (isset($options['exempt_from_batcache']) && !empty($options['exempt_from_batcache']))
{
    ...
    $obj_exclude_pages_from_batcache = WP_CONTENT_DIR . '/mu-plugins/pressable-cache-management/pcm-exclude-pages-from-batcache.php';
    ...
    {
        $obj_exclude_pages_from_batcache = plugin_dir_path(__FILE__) . '/exclude-pages-from-batcache-mu-plugin.php';		
        $obj_exclude_pages_from_batcache_active = WP_CONTENT_DIR . '/mu-plugins/pressable-cache-management/pcm-exclude-pages-from-batcache.php';
