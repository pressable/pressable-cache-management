<?php // Pressable Cache Management mu-plugins index loader
...
/*
 * This code checks if the pressable-cache-management mu-plugins 
 * are installed and refference it to the pressable-cache-management 
