...
function pressable_cache_management_callback_field_extend_cdn_radio_button($args)
{
    ...
    //Enable CDN button label
    $label = esc_html__('Enable CDN (Recommended)', 'pressable_cache_management');
    ...
    if (get_option('cdnenabled') == 'disable')
    {
        ...
        echo '<form method="post" id="enable_cdn_nonce">';

        echo '<span id="enable_cdn_nonce">';

        echo '<input id="cdn_settings_tab_options_' . $id . '" name="cdn_settings_tab_options[' . $id . ']" type="submit" size="40" value="' . __('Enable CDN', 'pressable_cache_management') . '" class="purgecacahe"/>';
        echo '<input type="hidden" name="enable_cdn_nonce" value="' . wp_create_nonce('enable_cdn_nonce') . '" <br/><label class="rad-text for="cdn_settings_tab_options_' . $id . '">' . $label . '</label>';;
    ...
    else
    {
        ...
        //Disable CDN button label
        $label = esc_html__('Disable CDN', 'pressable_cache_management');

        echo '</form>';

        echo '<form method="post" id="disable_cdn_nonce">';

        echo '<span id="disable_cdn_nonce">';

        echo '<input id="cdn_settings_tab_options_' . $id . '" name="cdn_settings_tab_options[' . $id . ']" type="submit" size="40" value="' . __('Disable CDN', 'pressable_cache_management') . '" class="purgecacahe"/>';
        echo '<input type="hidden" name="disable_cdn_nonce" value="' . wp_create_nonce('disable_cdn_nonce') . '" <br/><label class="rad-text for="cdn_settings_tab_options_' . $id . '">' . $label . '</label>';
...
global $pagenow;
$pressable_site_id_option = 'pressable_site_id';
...
if (is_multisite())
{
    ...
    elseif ($pagenow == 'admin.php' && $options['pressable_site_id'] !== get_option($pressable_site_id_option))
    {
        return;

    }
    elseif ($options['pressable_site_id'] && $options['pressable_site_id'] !== get_option($pressable_site_id_option))
    {

        $db_site_id = $options['pressable_site_id'];
        ...
        //Clear Client ID and Client Secret if site is cloned
...
if ($site_id_con_res === 'OK' && $pcm_con_auth === 'activated')
{
    ...
    $radio_option = array(
        ...
        'exclude_particular_file_from _cdn' => '',
...
function pressable_cache_management_callback_field_secret_text($args)
{
    ...
    */
    ...
    if ($site_id_con_res === 'OK' && $pcm_con_auth === 'activated')
    {
        ...
        // Add button to disconnect API
        echo '</form>';

        echo ' <form method="post" id="disconnect_api_nonce"> 

         <span id="disconnect_api_nonce_button">

              <input id="pressable_api_authentication_tab_options_' . $id . '" name="cdn_settings_tab_options[' . $id . ']" type="submit" size="40" value="' . __('Disconnect API', 'pressable_api_authentication_tab') . '" class="disconnect_api_nonce"/><input type="hidden" name="disconnect_api_nonce" value="' . wp_create_nonce('disconnect_api_nonce') . '" <br/>
    ...
    else
    {
        ...
        // Add button to connect API
        echo '</form>';

        echo ' <form method="post" id="connect_api_nonce"> 

         <span id="connect_api_nonce_button">

              <input id="pressable_api_authentication_tab_options_' . $id . '" name="cdn_settings_tab_options[' . $id . ']" type="submit" size="40" value="' . __('Connect API', 'pressable_api_authentication_tab') . '" class="connect_api_nonce"/><input type="hidden" name="connect_api_nonce" value="' . wp_create_nonce('connect_api_nonce') . '" <br/>
